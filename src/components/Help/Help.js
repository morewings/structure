    ...
    <Col offset={1} width={10}>
      <div className={classes.help}>
        <Typography>
          ...
          <h2>Board</h2>
          <Image
            className={classes.illustrationBig}
            src={boardImage}
            title="Default board view"
          />
          <p>
            <strong>Board</strong> is the default view of the structure. Board
            consists of three <strong>Columns</strong>.
          </p>
          <Image src={columnTitleImage} title="Column title" />
          <p>
            Each column has an icon which indicates the <strong>role</strong> of
            the Node and the <strong>title</strong> of the parent Node it shows
            contents for.
          </p>
          <dl>
            <dt>
            ...
            <dd>
              First column from the right contains the <strong>parent</strong>{' '}
              of the focused Node and parent&lsquo;s siblings.
            </dd>
            <dt>
              <Icon name="siblings" color="var(--accentColor)" />
            </dt>
            <dd>
              Second column contains focused Node and it&lsquo;s{' '}
            ...
            <dd>
              Third column contains focused Node&lsquo;s{' '}
              <strong>children</strong> nodes.
            </dd>
          </dl>
          <Image src={addNodeButtonImage} title="Add node button" />
          <p>
            To add new Node to the Column you have to click{' '}
            <strong>Add node</strong> button at the bottom.
          </p>
          <Image src={fabImage} title="Floating actions block" />
          <p>
            <strong>Floating actions</strong> at the left contains buttons to
            navigate your Structure and to manipulate it.
          </p>
          <dl>
            <dt>
              <Icon
                className={classes.iconBigger}
                name="rewind"
          ...
          <p>
            <strong>Node</strong> component shows specific node data from the
            Structure. You can tick checkbox <Icon name="checkbox-unchecked" />{' '}
            <Icon name="checkbox-checked" />
            at the top, view stats about Node generation and total amount of
            ancestors (children + children of children etc).
          </p>
          <p>
            Delete button <Icon name="delete" color="var(--actionColor)" /> on
            the right side removes node and it&lsquo;s ancestors from the
            Structure
          </p>
          <Image src={nodeFooterImage} title="Node footer" />
          Node footer in the bottom has two buttons. <strong>
            Edit node
          </strong>{' '}
          opens editing modal, <strong>Show children</strong> sets the left
          column to show children of this node.
        </Typography>
      </div>
    </Col>
  </Row>
